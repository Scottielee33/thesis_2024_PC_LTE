...
run_optimization <- function(start_year, start_quantile, chosen_components) {
  ...
  initial_average_performance <- average_performance(cpu_perf$start_perf, gpu_perf$start_perf_2d, gpu_perf$start_perf_3d, disk_perf$start_perf, memory_perf$start_perf, lambdas, start_quantile, 5, Inf, 1000, "CPU")
  print(initial_average_performance)
}
```

```{r}
run_optimization(2016, "First Quantile", "CPU")
```