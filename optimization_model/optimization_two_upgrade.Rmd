...
```{r}
run_optimization(2014, "First Quantile", c("GPU", "CPU"))
run_optimization(2015, "First Quantile", c("Disk", "CPU"))
run_optimization(2016, "First Quantile", c("Disk", "CPU"))
run_optimization(2017, "First Quantile", c("Disk", "CPU"))
```
